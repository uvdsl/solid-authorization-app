...
import { useAccessNeed } from '../../composables/store/requests/useAccessNeed';

const props = defineProps<{
    uri: string
}>();

const { accessNeed } = useAccessNeed(toRef(props, "uri"));
</script>
    ...
    <div class="grid align-items-start text-sm">
        <div class="col-12 sm:col-4">
            ...
            <div class="flex flex-wrap gap-2">
                <Chip v-for="accessMode in accessNeed?.accessModes" 
                      :key="accessMode" 
        ...
        <!-- <div  class="col-12 sm:col-4">
            ...
            <div class="flex flex-wrap gap-2">
                <a v-for="shapeTree in accessNeed?.registeredShapeTrees" 
                   :key="shapeTree" 
                   :href="shapeTree"
                   class="no-underline">
        ...
        <div class="col-12 sm:col-8">
            ...
            <div class="flex flex-wrap gap-2">
                <a v-for="dataInstance in accessNeed?.dataInstances" 
                   :key="dataInstance" 
                   :href="dataInstance"
                   class="no-underline">
